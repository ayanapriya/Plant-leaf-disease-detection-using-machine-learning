...
def openphoto():
    ...
    fileName = askopenfilename(initialdir=r'C:\Users\Acer\Desktop\project\PlantDiseaseDetection-master\test\test', title='Select image for analysis ',
                           filetypes=[('image files', '.jpg')])
    dst = r"C:\Users\Acer\Desktop\project\\PlantDiseaseDetection-master\testpicture"
